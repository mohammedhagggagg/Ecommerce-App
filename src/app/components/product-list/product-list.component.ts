...
PARENT.HTML -> <CHILD-SELECTOR SELECTOR  [PROPERTYNAME]="VALUE" ></CHILD-SELECTOR>
CHILD.TS ->@INPUT() PROPERTYNAME:TYPE;
...
PARENT.HTML -> CHILD SELECTOR (emitterInstanceEvent)="handlereceiveddata($event)"></CHILD SELECTOR>
PARENT.HTML -> handlereceiveddata(propertyName:Type){
                Logic
}
*/
