...
export class ProductDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const foundProduct = this.products.find(product => product.id === Number(params_id));
  
    if (foundProduct) {
     
      foundProduct.images = foundProduct.images.filter(img => img !== foundProduct.thumbnail);
      this.productDetails = foundProduct;
    } else {
